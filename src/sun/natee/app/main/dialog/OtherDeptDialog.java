...
public class OtherDeptDialog extends javax.swing.JDialog {

    private final Logger logger = Logger.getLogger(OtherDeptDialog.class);

    private Other data = null;

    public OtherDeptDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("เพิ่มข้อมูลหนี้สินนอกระบบ");
        setResizable(false);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "รายวัน", "รายสัปดาห์", "รายเดือน", "รายปี" }));
        ...
        jLabel10.setText("เพิ่มข้อมูลหนี้สินนอกระบบ");
